...
func readOnlyMethod(method string) bool {
	switch method {
	case MethodHealth, MethodGetRun, MethodGetStepDiff, MethodGetRuns, MethodGetRunsForHead, MethodGetActiveRun, MethodGetExecutingRuns, MethodGateContext, MethodAdmitPush:
		return true
	default:
		return false
	}
